...
const VALID_TABS = new Set(["home", "shops", "mural", "ranking", "robot", "gacha", "workbench", "diorama", "pose", "account", "cart"])
type TabKey = "home" | "shops" | "mural" | "ranking" | "robot" | "gacha" | "workbench" | "diorama" | "pose" | "account" | "cart"
