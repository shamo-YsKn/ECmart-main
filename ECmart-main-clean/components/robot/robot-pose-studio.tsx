      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-sm leading-relaxed text-muted-foreground">
            正面はXZ平面（左右＋高さ）、側面はYZ平面（前後＋高さ）として編集します。XとYはそれぞれ独立し、Z（高さ）だけを正面・側面で共有します。オレンジの点は操作中の同じ関節を示します。
          </p>
        </div>
      ...
      <Card className="border-2 border-primary/25 bg-primary/5">
        <CardContent className="flex flex-col gap-4 p-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="text-xs text-muted-foreground">白い丸をドラッグして編集します。正面の横移動は側面へ、側面の前後移動は正面へ影響せず、高さだけが同期します。</span>
          </div>
