...
export function WorkbenchPartShape({
  ...
  if (type === "wire") {
    return (
      <g>
        {selection}
        <path d="M-61 23 C-42 -28 -14 -29 0 0 C13 27 39 31 61 -19" fill="none" stroke={DARK} strokeWidth="9" strokeLinecap="round" />
        <path d="M-61 23 C-42 -28 -14 -29 0 0 C13 27 39 31 61 -19" fill="none" stroke="#a8b2b8" strokeWidth="5" strokeLinecap="round" />
      </g>
    )
  }
  ...
  if (type === "spring") {
    return (
      <g>
        {selection}
        <path d="M-65 0 L-54 -20 L-36 20 L-18 -20 L0 20 L18 -20 L36 20 L54 -20 L65 0" fill="none" stroke={DARK} strokeWidth="9" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M-65 0 L-54 -20 L-36 20 L-18 -20 L0 20 L18 -20 L36 20 L54 -20 L65 0" fill="none" stroke="#cbd2d5" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
      </g>
    )
  }

  const ledColor = type === "led_red" ? "#ef4444" : type === "led_green" ? "#22c55e" : "#eab308"
  return (
    <g>
      {selection}
